...
ClapTrap::ClapTrap():_name("Default ClapTrap"),_hitPoints(10), _attackDamage(0), _energyPoints(10){
	...
	std::cout<<RED<< "ClapTrap "<<LILA<< this->_name << " Default constructor called"<<RESET<< std::endl;
}
...
ClapTrap::ClapTrap( const ClapTrap & src )
			:_name(src._name + "copy"),
			 _hitPoints(src._hitPoints), _attackDamage(src._attackDamage),
			 _energyPoints(src._energyPoints){
	std::cout <<GREEN<< "ClapTrap "<<LILA<< this->_name << " Copy constructor called"<< RESET<<std::endl;
}
